...
def print_power():
    global last_update_time, peak_power, total_power_consumption, total_cost_since_start
    ...
    if power:
        ...
        # Ausgabe des Spitzenwertes in Rot
        peak_output = "".join(Fore.RED + line + "\n" for line in big_digits(f"{math.ceil(peak_power):.0f}"))
        peak_output += f"{Fore.RED}Spitzenwert in Watt.\n"
